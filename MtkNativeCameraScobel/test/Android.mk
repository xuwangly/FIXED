...
LOCAL_C_INCLUDES += $(TOP)/external/opencv_lenovo/include/opencv \
					 $(TOP)/external/opencv_lenovo/include \

#-----------------------------------------------------------
LOCAL_MODULE := preview_cb
#LOCAL_MODULE_TAGS := test
LOCAL_MODULE_TAGS := eng
LOCAL_PRELINK_MODULE := false
...
LOCAL_STATIC_LIBRARIES += libopencv_highgui
#						  libopencv_imgproc			\
						  libopencv_imgcodecs 		\
						  libopencv_calib3d  		\
						  libopencv_dnn      		\
